...
MetWAMer has been tested most recently (April 2025) on a 64-bit GNU/Linux system and it compiles cleanly under at least GCC versions 13.3.0 and 9.4.0. The package requires the libxml2 library; it was observed to work properly under version 2.9.14. It is otherwise self-contained, although host systems are encouraged to provide the GNU implementation of awk, gawk, if possible. Please see the manual page for usage details. This software is provided "**AS IS**".
